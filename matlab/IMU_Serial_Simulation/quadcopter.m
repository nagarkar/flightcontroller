...
function h = quadcopter()
    ...
    z = 0.5 * z;
    % Back
    h(3) = surf(x - 5, y, z, 'EdgeColor', 'none', 'FaceColor', 'r', 'Marker', 'o');
    %Right
    h(4) = surf(x + 5, y, z, 'EdgeColor', 'none', 'FaceColor', 'y',  'Marker', '+');
    %Yellow
    h(5) = surf(x, y - 5, z, 'EdgeColor', 'none', 'FaceColor', 'b',  'Marker', 'x');
    % Front
    h(6) = surf(x, y + 5, z, 'EdgeColor', 'none', 'FaceColor', 'g', 'Marker', 'v');

function test = isalmost(a,b,tol, scalarRet)
%
...
% scalarRet = If True, return a scalar (1 for true) or else return matrix
%
% outputs:
%
% test(nr,nc) = matrix of test results or scalar value
%

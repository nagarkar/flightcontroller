function [ofs,gain,rotM]=EllipsoidFit(XYZ,varargin)
...
y = XYZ(:,2);
z = XYZ(:,3);
if nargin>1, f=varargin{1}; else f=0; end;

% Decide the form of D, based on what kind of fit we want.
...
% Estimate v using least squares fitting.
